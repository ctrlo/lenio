...
-- Created on Wed Jan 29 14:42:04 2025
--
;
...
CREATE TABLE `task` (
  ...
  `bespoke` smallint NOT NULL DEFAULT 0,
...
CREATE TABLE `ticket` (
  ...
  INDEX `ticket_idx_parent_id` (`parent_id`),
  ...
  CONSTRAINT `ticket_fk_parent_id` FOREIGN KEY (`parent_id`) REFERENCES `ticket` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
